<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kategoriKayit.aspx.cs" Inherits="bakkal.admin.kategoriKayit" %>
...
<%--        <tr>
        ...
        <tr>
            ...
            <td style="width:300px; height:30px;"><asp:TextBox ID="TextBox1" runat="server" Width="200px" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Height="22px"></asp:TextBox>
            </td>
        </tr>
        <%--<tr>
...
<%--            </asp:TemplateField>--%>
            ...
            <asp:BoundField DataField="kullanici_adi" HeaderText="Kullanıcı Adı"></asp:BoundField>
             <asp:BoundField DataField="yetki" Visible="False" />
      ...
      <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
          <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © bootstrapdash.com 2020ight © bootstrapdash.com 2020</span>
